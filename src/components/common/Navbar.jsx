          ...
          <div className="flex justify-between items-center">
            ...
            >
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-[#D14D72] to-pink-300 rounded-full flex items-center justify-center">
                  <span className="text-white font-bold text-lg">G</span>
                </div>
                <div className="absolute -inset-1 bg-gradient-to-r from-[#D14D72] to-pink-300 rounded-full blur opacity-30"></div>
              </div>
              <div>
